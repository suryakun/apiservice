!function($, wysi) {
    ...
    var tpl = {
        ...
        "emphasis": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group '>" +
                "<a class='btn btn-white" + size + "' data-wysihtml5-command='bold' title='CTRL+B'>" + 'B' + "</a>" +
                "<a class='btn btn-white" + size + "' data-wysihtml5-command='italic' title='CTRL+I'>" + 'I' + "</a>" +
                "<a class='btn btn-white" + size + "' data-wysihtml5-command='underline' title='CTRL+U'>" + 'U' + "</a>" +
              "</div>" +
            "</li>";
        },
