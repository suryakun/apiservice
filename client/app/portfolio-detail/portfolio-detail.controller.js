'use strict';
angular.module('roomApp').controller('PortfolioDetailCtrl', ['$scope', 'storyDetailHttp', '$http', 'socket', '$state', '$rootScope', 'appAuth', function($scope, storyDetailHttp, $http, socket, $state, $rootScope, appAuth) {
