...
//===== end pandu ==========
    ...
    setTimeout(function (argument) {
        var ca1 = ['endang@pandu.sch.id','ancilla@pandu.sch.id'];
        var ca2 = ['rida@pandu.sch.id','ancilla@pandu.sch.id'];
        var cb1 = ['desy@pandu.sch.id','ancilla@pandu.sch.id'];
        var cb2 = ['karolina@pandu.sch.id','ancilla@pandu.sch.id'];
        var cpg = ['maranatha@pandu.sch.id','ancilla@pandu.sch.id'];
    ...
    setTimeout(function (argument) {
            ...
            var teachername = ['ancilla@pandu.sch.id','desy@pandu.sch.id','endang@pandu.sch.id','maranatha@pandu.sch.id','karolina@pandu.sch.id','rida@pandu.sch.id'];
